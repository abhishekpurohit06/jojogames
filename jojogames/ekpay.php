	...
	<body class="modal-open" style="overflow: auto;">
		<div class="setp" id="setp-1" style="display:block">
			<div class="navbar navbar-default" style="margin-bottom: 0;position: relative">
				<h4 class="text-center tit"><img src="assets\img\upi.png" width="110px" height="40px">Payment</h4>
			...
			<div class="container-fluid highlight">
				<div style="margin: 0 auto;max-width: 520px">
					<div class="payment-model" data-model="upi">
						...
						The amount you need to Payable
							<br>
							<span class="amo">₹&nbsp;<?php echo $ramt; ?></span>
						</h3>
						<div class="upi-info">
							<div>
								Pay to UPI: <br>
						...
						<div class="upi-payment-step">
							...
							<input type="text" id="upi-input" value="" name="channel_order" placeholder="ENTER UTR NO.:3045xxxxxxxx" maxlength="12" oninput="this.value=this.value.replace(/[^\d]/g,'')" onchange="this.value=this.value.replace(/[^\d]/g,'')">
						</div>
						<div class="enter-ref-warn-box">
							<div class="enter-ref-warn">
								You must fill in the correct UTR No.,then click the button below to submit,and wait for it to arrive!
							</div>
					...
					<div class="box">
						<div class="text-left">
							<p class="level-2" style="margin-bottom:0;color:#333;">UTR No. Example</p>
