	...
	<div data-v-5f666fee="" class="win" style="margin-bottom: 6px;">
		...
		<div data-v-5f666fee="" class="main">
			...
			<div data-v-5f666fee="" class="center_text">
				...
				<ul style="background-color: #eeeeee; padding-top: 15px; padding-bottom: 15px; border-radius: 2rem;" data-v-5f666fee="" class="center_notes">
					<li data-v-5f666fee="">
					<button data-v-5f666fee="" class="gbutton" style="padding: 0; border: none; background: none;" onClick="betbutton('#0D96F3','number','0');">
							<img src="assets\img\png\n0-51213645.png" width="70px" height="70px">
						</button>
					</li>
					<li data-v-5f666fee="">
					<button data-v-5f666fee="" class="gbutton" style="padding: 0; border: none; background: none;" onClick="betbutton('#0D96F3','number','1');">
							<img src="assets\img\png\n1-8de0d143.png" width="70px" height="70px">
						</button>
					</li>
					<li data-v-5f666fee="">
						<button data-v-5f666fee="" class="gbutton" style="padding: 0; border: none; background: none;" onClick="betbutton('#0D96F3','number','2');">
							<img src="assets\img\png\n2-83e5ee6e.png" width="70px" height="70px">
						</button>

					</li>
					<li data-v-5f666fee="">
						<button data-v-5f666fee="" class="gbutton" style="padding: 0; border: none; background: none;" onClick="betbutton('#0D96F3','number','3');">
							<img src="assets\img\png\n3-1a88ea08.png" width="70px" height="70px">
						</button>
					</li>
					<li data-v-5f666fee="">
					<button data-v-5f666fee="" class="gbutton" style="padding: 0; border: none; background: none;" onClick="betbutton('#0D96F3','number','4');">
							<img src="assets\img\png\n4-05ab0431.png" width="70px" height="70px">
						</button>
					</li>
					<li data-v-5f666fee="">
					<button data-v-5f666fee="" class="gbutton" style="padding: 0; border: none; background: none;" onClick="betbutton('#0D96F3','number','5');">
							<img src="assets\img\png\n5-5eed76ab.png" width="70px" height="70px">
						</button>
					</li>
					<li data-v-5f666fee="">
					<button data-v-5f666fee="" class="gbutton" style="padding: 0; border: none; background: none;" onClick="betbutton('#0D96F3','number','6');">
							<img src="assets\img\png\n6-d7438cd9.png" width="70px" height="70px">
						</button>
					</li>
					<li data-v-5f666fee="">
					<button data-v-5f666fee="" class="gbutton" style="padding: 0; border: none; background: none;" onClick="betbutton('#0D96F3','number','7');">
							<img src="assets\img\png\n7-1d3858e0.png" width="70px" height="70px">
						</button>
					</li>
					<li data-v-5f666fee="">
					<button data-v-5f666fee="" class="gbutton" style="padding: 0; border: none; background: none;" onClick="betbutton('#0D96F3','number','8');">
							<img src="assets\img\png\n8-c10e1c90.png" width="70px" height="70px">
						</button>
					</li>
					<li data-v-5f666fee="">
					<button data-v-5f666fee="" class="gbutton" style="padding: 0; border: none; background: none;" onClick="betbutton('#0D96F3','number','9');">
							<img src="assets\img\png\n9-b0db0556.png" width="70px" height="70px">
						</button>
					</li>
				</ul>
			</div>
