				...
				<div data-v-4a43e45d="" class="mine_info">
					<div data-v-4a43e45d="" class="mine_info_top">
						<div data-v-4a43e45d="" class="info_left">
							<img data-v-4a43e45d="" style="background-color:#0081ff;" alt="" class="photo_img" src="assets\img\headimg.png">
							<ul data-v-4a43e45d="">
						...
						<div data-v-4a43e45d="" class="info_right" id="notice">
							...
							<div style="color: white; padding:5px;" data-v-4a43e45d="">Mobile: <?php echo user($con,'mobile',$userid);?></div>
						
						
					<div style="color: white; padding:5px;" data-v-4a43e45d="">Balance:₹ <?php echo number_format(wallet($con,'amount',$userid), 2);?></div>
					<button style="background-color: #39b54a; border-radius:6px; border-color:#39b54a; color: white; padding:5px; " data-v-4a43e45d="" class="recharge" onclick="window.location.href='recharge.php';">
								Recharge
							</button>
				</div>
			</div>
